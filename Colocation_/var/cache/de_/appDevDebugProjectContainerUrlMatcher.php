    ...
    public function match($pathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/annonces')) {
            ...
            if ('/annonces' === $trimmedPathinfo) {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\AnnoncesController::indexAction',  '_route' => 'annonces_index',);
            }
            not_annonces_index:

            // annonces_new
            if ('/annonces/new' === $pathinfo) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_annonces_new;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\AnnoncesController::newAction',  '_route' => 'annonces_new',);
            }
            not_annonces_new:
            ...
            // annonces_edit
            if (preg_match('#^/annonces/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
