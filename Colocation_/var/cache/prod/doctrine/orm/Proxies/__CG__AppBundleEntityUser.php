...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'colocataire', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setColocataire(\AppBundle\Entity\Les_Colocataires $colocataire)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setColocataire', [$colocataire]);

        return parent::setColocataire($colocataire);
    }
    ...
    public function getColocataire()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getColocataire', []);

        return parent::getColocataire();
    }
