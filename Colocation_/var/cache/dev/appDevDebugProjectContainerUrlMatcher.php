...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // annonces_index
        if (preg_match('#^/(?P<_locale>[^/]++)/annonces/?$#s', $pathinfo, $matches)) {
            if ('GET' !== $canonicalMethod) {
                $allow[] = 'GET';
            ...
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'annonces_index');
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'annonces_index')), array (  '_controller' => 'AppBundle\\Controller\\AnnoncesController::indexAction',));
        }
        not_annonces_index:

        // annonces_new
        if (preg_match('#^/(?P<_locale>[^/]++)/annonces/new$#s', $pathinfo, $matches)) {
            if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                $allow = array_merge($allow, array('GET', 'POST'));
                goto not_annonces_new;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'annonces_new')), array (  '_controller' => 'AppBundle\\Controller\\AnnoncesController::newAction',));
        }
        not_annonces_new:

        // annonces_seloger
        if (preg_match('#^/(?P<_locale>[^/]++)/annonces/(?P<id>[^/]++)/seloger$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'annonces_seloger')), array (  '_controller' => 'AppBundle\\Controller\\AnnoncesController::selogerAction',));
        }

        // annonces_show
        if (preg_match('#^/(?P<_locale>[^/]++)/annonces/(?P<id>[^/]++)/voir$#s', $pathinfo, $matches)) {
            if ('GET' !== $canonicalMethod) {
                $allow[] = 'GET';
                goto not_annonces_show;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'annonces_show')), array (  '_controller' => 'AppBundle\\Controller\\AnnoncesController::showAction',));
        }
        not_annonces_show:

        // annonces_edit
        if (preg_match('#^/(?P<_locale>[^/]++)/annonces/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
            if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                $allow = array_merge($allow, array('GET', 'POST'));
                goto not_annonces_edit;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'annonces_edit')), array (  '_controller' => 'AppBundle\\Controller\\AnnoncesController::editAction',));
        }
        not_annonces_edit:

        // annonces_delete
        if (preg_match('#^/(?P<_locale>[^/]++)/annonces/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            if ('DELETE' !== $canonicalMethod) {
                $allow[] = 'DELETE';
                goto not_annonces_delete;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'annonces_delete')), array (  '_controller' => 'AppBundle\\Controller\\AnnoncesController::deleteAction',));
        }
        not_annonces_delete:
        ...
        // rss
        if ('/rss' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::rssAction',  '_route' => 'rss',);
        }
